...
winget uninstall %param% -e --id "Inkscape"
echo %green%Gimp
...
winget uninstall %param% --name "Ultimaker Cura 5.3.0"
...
winget uninstall %param% -e --name "Intel(R) C++ Redistributables on Intel(R) 64"
