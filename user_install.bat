@echo off
set param=--uninstall-previous --accept-source-agreements --accept-package-agreements --scope user --silent --disable-interactivity
...
winget install %param% -e --id "9NRWMJP3717K"
